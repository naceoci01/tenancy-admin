    ...
    var.create_exa == true ? {
      "CE-EXACS-POLICY" : {
        ...
        statements : [
          ...
          "allow group ${local.core_policy_group_name} to manage db-backups in compartment ${local.core_policy_shared_compartment}:exacs //Allow CE to manage database backups for ExaCS",
